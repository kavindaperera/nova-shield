...
public class BluetoothUtils {
    ...
    public static UUID baseUuid = UUID.fromString("00002902-0000-1000-8000-00805f9b34fb");
    ...
    public static UUID getBluetoothUuid() {
        if (bluetoothUuid == null) {
            bluetoothUuid = BluetoothUtils.getHashedBluetoothUuid(false);
        }
    ...
    public static UUID getHashedCharacteristicUuid(String string) {
        ...
        byte[] arrby2 = Arrays.copyOfRange(arrby, 0, 16);
        arrby2[arrby2.length - 1] = (byte)(false ? 255 : 238);
        ByteBuffer byteBuffer = ByteBuffer.wrap(arrby2);
    ...
    public static List<ScanFilter> getBluetoothLeScanFilter() {
        ...
        builder.setServiceUuid(new ParcelUuid(BluetoothUtils.getHashedBluetoothLeUuid(false)));
        arrayList.add(builder.build());
        builder = new ScanFilter.Builder();
        builder.setServiceData(new ParcelUuid(BluetoothUtils.getHashedBluetoothLeUuid(false)), null);
        arrayList.add(builder.build());
        return arrayList;
    }
...
//        builder.setScanMode(1); // SCAN_MODE_BALANCED
    ...
    public static AdvertiseData getAdvertiseData(String uuid) throws IOException{
        ...
        builder.addServiceData(new ParcelUuid(BluetoothUtils.getHashedBluetoothLeUuid(false)), BluetoothUtils.getData(uuid));

...
public class ShieldConstants {
    public static final class string {
        ...
        public static final int exposed = R.string.exposed;
    ...
    public static final class drawable {
        public static final int shld = R.drawable.shield;
        public static final int shld_launcher = R.drawable.ic_launcher_round;
    }
}

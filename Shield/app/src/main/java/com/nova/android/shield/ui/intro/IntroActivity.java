package com.nova.android.shield.ui.intro;
...
public class IntroActivity extends AppCompatActivity {
    ...
    private static String TAG = "[Nova][Shield][IntroActivity]";
    ...
    private void setupOnboardingItems() {
        ...
        itemOne.setTitle(getString(ShieldConstants.string.onboarding_title_1));
        itemOne.setDescription(getString(ShieldConstants.string.onboarding_description_1));
        itemOne.setImage(R.drawable.onboarding_1);

        OnboardingItem itemTwo = new OnboardingItem();
        itemTwo.setTitle(getString(ShieldConstants.string.onboarding_title_2));
        itemTwo.setDescription(getString(ShieldConstants.string.onboarding_description_2));
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == AUTHUI_REQUEST_CODE) {
            ...
            if (response == null) {
                Log.i(TAG, "null response: " + response);
            } else {
    ...
    public void startVerification(View v) {
        if (mViewPager.getCurrentItem() + 1 < onboardingAdapter.getItemCount()) {
            ...
            Intent intent = AuthUI.getInstance()
                    ...
                    .setTosAndPrivacyPolicyUrls(getString(ShieldConstants.string.url_tos), getString(ShieldConstants.string.url_privacy))
                    .setLogo(R.drawable.ic_launcher_auth)
